    ...
    public void onUpdateReceived(Update update) {
        ...
        if (message != null && message.hasText()) {
            ...
            // Команда Рецепт Дня
                ...
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message.getChatId()));
                waterService.deleteIndividualWaterBalance(String.valueOf(message.getChatId()));
            ...
            // Выбор пола в методе Индивидуальный расчет калорий
                ...
                if (!Pattern.matches("[0-9]+[\\.]?[0-9]*", message.getText())) {
                    ...
                    databaseService.insertIndividualDataToSql(String.valueOf(message.getChatId()), "4", message.getText());
            ...
            else if (message.getText() != null && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message.getChatId()), "2") && !databaseService.checkIndividualCaloriesCalculation(String.valueOf(message.getChatId()), "3") && !message.getText().equals("Калории продуктов") && !message.getText().equals("Счетчик калорий") && !message.getText().equals("Водный баланс") && !message.getText().equals("Рецепты")) {
                message.getChatId();
                if (!Pattern.matches("[0-9]+[\\.]?[0-9]*", message.getText())) {
                    ...
                    databaseService.insertIndividualDataToSql(String.valueOf(message.getChatId()), "3", message.getText());
            ...
            else if (message.getText() != null && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message.getChatId()), "1") && !databaseService.checkIndividualCaloriesCalculation(String.valueOf(message.getChatId()), "2") && !message.getText().equals("Калории продуктов") && !message.getText().equals("Счетчик калорий") && !message.getText().equals("Водный баланс") && !message.getText().equals("Рецепты")) {
                message.getChatId();
                if (!Pattern.matches("[0-9]+[\\.]?[0-9]*", message.getText())) {
                    inlineButton1(message, "Пожайлуста вводите только цифры\nВведите свой рост(например: 175): ");
                } else if (Double.parseDouble(message.getText()) < 250 && Double.parseDouble(message.getText()) > 0) {
                    inlineButton1(message, "Введите свой вес(например: 50): ");
                    databaseService.insertIndividualDataToSql(String.valueOf(message.getChatId()), "2", message.getText());
            ...
            //Выбор роста в методе Индивидуальный расчет калорий
                ...
                databaseService.insertIndividualDataToSql(String.valueOf(message.getChatId()), "1", "1");

            } else if (message.getText() != null && waterService.checkWaterBalance(String.valueOf(message.getChatId()), "1") && !message.getText().equals("Калории продуктов") && !message.getText().equals("Счетчик калорий") && !message.getText().equals("Водный баланс") && !message.getText().equals("Рецепты")) {
                if (!Pattern.matches("[0-9]+[\\.]?[0-9]*", message.getText())) {
                    inlineButton1(message, "Пожайлуста вводите только цифры\nВведите свой вес(например: 50): ");
                } else if (Double.parseDouble(message.getText()) < 150 && Double.parseDouble(message.getText()) > 10) {
                    databaseService.insertWaterBalanceToSql(String.valueOf(message.getChatId()), "2", message.getText());
                    String response = waterService.individualWaterBalance(String.valueOf(message.getChatId()));
                ...
                databaseService.insertWaterBalanceToSql(String.valueOf(message.getChatId()), "1", "1");
            ...
            if (data.equals("Хватит")) {
                ...
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message1.getChatId()));
                waterService.deleteIndividualWaterBalance(String.valueOf(message1.getChatId()));
                hashForProducts.clear();
            ...
            // Реакция на Да в Inline меню в выборе упоминаний пить воду
                ...
                databaseService.insertChatIdInWaterReminderSQL(String.valueOf(message1.getChatId()));

            } else if (data.equals("Нет")) {
                sendMessage.setChatId(String.valueOf(message1.getChatId()));
                sendMessage.setText("Значит в другой раз");
                databaseService.deleteChatIdInWaterReminderSQL(String.valueOf(message1.getChatId()));
            ...
            // Реакция на выбор пола Мужской в Inline меню
                ...
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "5", "88.36");


                // Реакция на выбор пола Женский в Inline меню
            } else if (data.equals("Женский")) {
                inlineButton4(message1, "Выберите степень физической активности из списка:");
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "5", "447.6");

                // Реакция на выбор "Нет физических нагрузок" в Inline меню
            } else if (data.equals("Нет физических нагрузок") && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message1.getChatId()), "5")) {
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "6", "1.2");
                sendMessage.setText("Ваша суточная норма употребления каллорий: " + databaseService.individualCaloriesCalculation(String.valueOf(message1.getChatId())));
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message1.getChatId()));


                // Реакция на выбор "Нагрузки 1–3 раза в неделю" в Inline меню
            } else if (data.equals("Нагрузки 1–3 раза в неделю") && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message1.getChatId()), "5")) {
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "6", "1.375");
                sendMessage.setText("Ваша суточная норма употребления каллорий: " + databaseService.individualCaloriesCalculation(String.valueOf(message1.getChatId())));
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message1.getChatId()));


                // Реакция на выбор "Нагрузки 3–5 раз в неделю" в Inline меню
            } else if (data.equals("Нагрузки 3–5 раз в неделю") && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message1.getChatId()), "5")) {
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "6", "1.55");
                sendMessage.setText("Ваша суточная норма употребления каллорий: " + databaseService.individualCaloriesCalculation(String.valueOf(message1.getChatId())));
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message1.getChatId()));


                // Реакция на выбор "Нагрузки 6–7 раз в неделю" в Inline меню
            } else if (data.equals("Нагрузки 6–7 раз в неделю") && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message1.getChatId()), "5")) {
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "6", "1.725");
                sendMessage.setText("Ваша суточная норма употребления каллорий: " + databaseService.individualCaloriesCalculation(String.valueOf(message1.getChatId())));
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message1.getChatId()));

                // Реакция на выбор "Ежедневно более одной тренировки" в Inline меню
            } else if (data.equals("Ежедневно более одной тренировки") && databaseService.checkIndividualCaloriesCalculation(String.valueOf(message1.getChatId()), "5")) {
                databaseService.insertIndividualDataToSql(String.valueOf(message1.getChatId()), "6", "1.9");
                sendMessage.setText("Ваша суточная норма употребления каллорий: " + databaseService.individualCaloriesCalculation(String.valueOf(message1.getChatId())));
                databaseService.deleteIndividualCaloriesCalculation(String.valueOf(message1.getChatId()));
